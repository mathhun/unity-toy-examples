...
public class LevelRootViewModelBase : ViewModel {
    ...
    public P<Boolean> _ScoreProperty;
    ...
    public override void Bind() {
        ...
        _ScoreProperty = new P<Boolean>(this, "Score");
    ...
    public virtual Boolean ComputeScore() {
        return default(Boolean);
    }
...
public partial class LevelRootViewModel : LevelRootViewModelBase {
    ...
    public virtual P<Boolean> ScoreProperty {
        get {
            return this._ScoreProperty;
        }
    }
    
    public virtual Boolean Score {
        get {
